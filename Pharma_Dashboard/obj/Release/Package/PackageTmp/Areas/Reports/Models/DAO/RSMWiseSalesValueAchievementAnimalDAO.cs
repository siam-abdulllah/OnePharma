...
{
    public class RSMWiseSalesAchievementAnimalDAO
    {
        ...
        public List<RSMWiseSalesAchievementValue> GetRSMWiseSalesValueAchievementAnimal(string fromDate, string toDate)
        {
            ...
            string RValueQry = "SELECT ROW_NUMBER () OVER (ORDER BY ZONE_CODE) SL_NO," +
                            ...
                            "          FROM EMPLOYEE_INFO" +
                            "         WHERE ZONE_CODE = A.ZONE_CODE AND POSTING_LOCATION = 'Z' AND STATUS='A')" +
                            "          DSM_CODE," +
                            "       FN_EMPLOYEE_NAME (" +
                            "          (SELECT DISTINCT EMPLOYEE_CODE" +
                            "             FROM EMPLOYEE_INFO" +
                            ...
                            "       (SELECT DISTINCT EMPLOYEE_CODE" +
                            "          FROM EMPLOYEE_INFO" +
                            "         WHERE AREA_CODE = A.REGION_CODE AND POSTING_LOCATION = 'R' AND STATUS='A')" +
                            "          RSM_CODE," +
                            "       FN_EMPLOYEE_NAME (" +
                            "          (SELECT DISTINCT EMPLOYEE_CODE" +
                            "             FROM EMPLOYEE_INFO" +
                            ...
                            "                           0 UPTO_SALES," +
                            "                           0 LM_UPTO_SALES," +
                            "                           COUNT (DISTINCT EMPLOYEE_CODE) CM_MPO," +
                            "                           0 LM_MPO," +
                            "                           0 CM_CUST," +
                            "                           0 LM_CUST," +
                            "                           0 TODATE_COLLECT_AMT," +
                            ...
                            "                                  (SELECT EMPLOYEE_CODE FROM EMPLOYEE_INFO)" +
                            "                  GROUP BY ZONE_CODE, AREA_CODE" +
                            "                  UNION ALL" +
                            "                    SELECT ZONE_CODE," +
                            "                           AREA_CODE REGION_CODE," +
                            ...
                            "                           0 LM_UPTO_SALES," +
                            "                           0 CM_MPO," +
                            "                           COUNT (DISTINCT EMPLOYEE_CODE) LM_MPO," +
                            "                           0 CM_CUST," +
                            "                           0 LM_CUST," +
                            "                           0 TODATE_COLLECT_AMT," +
                            "                           0 UPTO_COLLECT_AMT" +
                            ...
                            "                                  TO_DATE ('" + toDate + "', 'DD/MM/RRRR') " + accessLevelParam + "" +
                            "                           AND C.EMPLOYEE_CODE IN" +
                            "                                  (SELECT EMPLOYEE_CODE FROM EMPLOYEE_INFO)" +
                            "                  GROUP BY C.ZONE_CODE, C.AREA_CODE" +
                            "                  UNION ALL" +
                            "                    SELECT C.ZONE_CODE," +
                            "                           C.AREA_CODE REGION_CODE," +
                            "                           0 TARGET_AMT," +
                            ...
                            "                                  (SELECT EMPLOYEE_CODE FROM EMPLOYEE_INFO)" +
                            "                  GROUP BY C.ZONE_CODE, C.AREA_CODE)" +
                            "        GROUP BY ZONE_CODE, REGION_CODE) A";



            #endregion
            DataTable DCSdt = dbHelper.GetDataTable(dbConn.SAConnStrReader("DashboardAnimal"), RValueQry);
