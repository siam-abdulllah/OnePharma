...
{
    public class ZoneWiseSalesAchievementAnimalDAO
    {
        ...
        public List<ZoneWiseSalesAchievementValue> GetZoneWiseSalesValueAchievementAnimal(string fromDate, string toDate)
        {
            ...
            string ZDAValueQry = " SELECT ROW_NUMBER () OVER (ORDER BY ZONE_CODE) SL_NO," +
                                    ...
                                    "                           0 TODATE_COLLECT_AMT," +
                                    "                           0 UPTO_COLLECT_AMT" +
                                    "                      FROM INVOICE_MST A LEFT JOIN RETURN_RECEIVE_MST B ON A.INVOICE_NO=B.INVOICE_NO" +
                                    "                     WHERE     INV_TYPE_CODE IN ('INV001', 'INV002')" +
                                 "                           AND TO_DATE (INVOICE_DATE, 'DD/MM/RRRR') BETWEEN TO_DATE (" +
                                   ...
                                   "                           AND TO_DATE (A.COLLECT_DATE, 'DD/MM/RRRR') = TO_DATE (" +
                                    "                                                                                 '" + toDate + "'," +
                                    "                                                                                 'DD/MM/RRRR') " + accessLevelParam + "" +
            ...
            DataTable DCSdt = dbHelper.GetDataTable(dbConn.SAConnStrReader("DashboardAnimal"), ZDAValueQry);
