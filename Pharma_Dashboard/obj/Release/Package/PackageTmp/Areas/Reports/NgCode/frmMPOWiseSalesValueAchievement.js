app.controller("myCtrl", function ($scope, $http, uiGridConstants) {
    ...
    $scope.gridMWiseSalesAchOptionsValue = {
        ...
        exporterCsvFilename: 'MPO_Wise_Sales_Achievement_Human.csv',
    ...
    $scope.GetMPOWiseSalesValueAchievement = function () {
        ...
        $http({
            method: "POST",
            url: MyApp.rootPath + "MPOWiseSalesAchievement/GetMPOWiseSalesValueAchievement",
